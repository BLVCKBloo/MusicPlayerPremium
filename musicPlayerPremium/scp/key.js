  ...
  handleEvent: function () {
    ...
    function dragElement(elmnt) {
      ...
      var pos1 = 0,
        ...
        pos3 = 0,
        pos4 = 0;
      if (document.getElementById(getParentElement.id + "header")) {
        // if present, the header is where you move the DIV from:
        document.getElementById(getParentElement.id + "header").onmousedown =
          dragMouseDown;
      } else {
        // otherwise, move the DIV from anywhere inside the DIV:
        getParentElement.onmousedown = dragMouseDown;
      }

      function dragMouseDown(e) {
        elmnt.querySelector(".list-btn-span").classList.add("disable");
        e = e || window.event;
        e.preventDefault();
      ...
      function elementDrag(e) {
        ...
        getParentElement.style.top = getParentElement.offsetTop - pos2 + "px";
        getParentElement.style.left = getParentElement.offsetLeft - pos1 + "px";
      }
